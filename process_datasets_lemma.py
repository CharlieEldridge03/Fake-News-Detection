...
def process_ISOT_dataset():
    ...
    for file_path in file_paths:
        ...
        for _, row in file_contents.iterrows():
            ...
            full_title_tokens, lemmatized_tokens_title = get_cleaned_tokens(title)
            full_text_tokens, lemmatized_tokens_text = get_cleaned_tokens(text)

            lemmatized_tokens_title = " ".join(lemmatized_tokens_title)
            lemmatized_tokens_text = " ".join(lemmatized_tokens_text)
            ...
            ISOT_title_data["text"].append(lemmatized_tokens_title)
            ...
            ISOT_text_data["text"].append(lemmatized_tokens_text)
...
def process_LIAR_dataset():
    ...
    for file_path in file_paths:
        ...
        for _, row in file_contents.iterrows():
            ...
            full_text_tokens, lemmatized_tokens = get_cleaned_tokens(text)
            ...
            LIAR_data["text"].append(lemmatized_tokens)
